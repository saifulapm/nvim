...
_G.packer_plugins = {
  ...
  ["better-escape.vim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/saiful/.local/share/nvim/site/pack/packer/opt/better-escape.vim"
  },
  ["bufferline.nvim"] = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp_luasnip", "cmp-spell", "nvim-autopairs", "tabout.nvim", "cmp-buffer" },
  ...
  ["telescope.nvim"] = {
    after = { "telescope-tmux.nvim", "telescope-smart-history.nvim", "cheatsheet.nvim", "telescope-fzf-native.nvim", "telescope-frecency.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'treesitter-unit', 'nvim-treesitter', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'LuaSnip', 'better-escape.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
